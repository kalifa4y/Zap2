...
# TikTok Developer Verification File Route
@app.get("/tiktokMC3rjSTv0WXJSWtQamUgBpW35hMLGHh8.txt", response_class=PlainTextResponse)
def tiktok_verification():
    return "tiktok-developers-site-verification=MC3rjSTv0WXJSWtQamUgBpW35hMLGHh8"
